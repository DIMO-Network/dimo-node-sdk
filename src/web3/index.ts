...
import { CHAIN_ABI_MAPPING, ENV_MAPPING, ENV_NETWORK_MAPPING } from "../utils/constants";
...
export class DimoWeb3Client {
  ...
  constructor(env: string, rpcURL: string, paymasterURL: string, bundlerURL: string) {
    this.env = ENV_MAPPING.get(env) || ENVIRONMENT.PROD;
    this.chainAddrMapping = CHAIN_ABI_MAPPING[this.env];
